...
urlpatterns = [
    ...
    path('SalesManagementSystemApp/Home/AdminCustomerSignIn/', views.AdminCustomerSignInMethod,name='AdminCustomerSignInPage'),
    path('SalesManagementSystemApp/Home/AdminCustomer/', views.AdminCustomerFormMethod, name='AdminCustomerInsertPage'),
    path('SalesManagementSystemApp/Home/AdminCustomerList/', views.AdminCustomerListMethod,name='AdminCustomerListPage'),
    path('SalesManagementSystemApp/Home/UpdateAdminCustomer/<int:id>/', views.AdminCustomerFormMethod,name='AdminCustomerUpdatePage'),
    path('SalesManagementSystemApp/Home/DeleteAdminCustomer/<int:id>/',views.AdminCustomerDelete,name='AdminCustomerDeletePage'),
    ...
    path('SalesManagementSystemApp/KeyPriorities/HR/<str:username>/<str:company_name>/GenerateStagePDF/', views.HRTableGenerate_PDF, name='HRTableGenerate_PDF'),
    ...
    path('SalesManagementSystemApp/KeyPriorities/CustService/<str:username>/<str:company_name>/GenerateStagePDF/', views.CustServiceTableGenerate_PDF, name='CustServiceTableGenerate_PDF'),
    ...
    path('SalesManagementSystemApp/KeyPriorities/IT/<str:username>/<str:company_name>/GenerateStagePDF/', views.ITTableGenerate_PDF, name='ITTableGenerate_PDF'),
    ...
    path('SalesManagementSystemApp/KeyPriorities/Sales/<str:username>/<str:company_name>/GenerateStagePDF/', views.SalesTableGenerate_PDF, name='SalesTableGenerate_PDF'),
    ...
    path('SalesManagementSystemApp/KeyPriorities/RD/<str:username>/<str:company_name>/GenerateStagePDF/', views.RDTableGenerate_PDF, name='RDTableGenerate_PDF'),
